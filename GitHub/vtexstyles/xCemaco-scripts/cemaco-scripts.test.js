    ...
    function changePLPTitle(){
        ...
        if (window.location.pathname == "/") {
            ...
            if ( window.location.search == "?lid=e89fcb92-f3d1-4241-8e99-49992630c951") {
                ...
                var url1='/superblack';
                if($('#productsSlider01 .prateleira').length){
                    $('.home .products-slider__wrapper .products-slider__container #productsSlider01 .prateleira > h2').after('<a class="text-center" href="'+url1+'"><p>Ver todo</p></a>');
                }
                // Link productsSlider02 Gran Venta
                var url2='/superblack';
                if($('#productsSlider02 .prateleira').length){
                    $('.home .products-slider__wrapper .products-slider__container #productsSlider02 .prateleira > h2').after('<a class="text-center" href="'+url2+'"><p>Ver todo</p></a>');
                }
                if(typeof load_discount_flags !== 'undefined'){
                    load_discount_flags();
                }
