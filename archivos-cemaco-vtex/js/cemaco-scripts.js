        ...
        if(window.location.href.indexOf("/_secure/account#/orders") > -1){
            var setTitle = setInterval(function(){
                if ($('.vtex-account__orders-list .t-heading-3 .c-on-base').text() == '¡Usted todavia no tiene pedidos!') {
                    $('.vtex-account__orders-list .t-heading-3 .c-on-base').text('¡Bienvenido! Aqu\u00ED podr\u00E1s visualizar y todos tus pedidos a partir de ahora.')
                }else {
        ...
        if (window.location.href.indexOf("/c-plomeria") > -1) {
         ...
         if (window.location.href.indexOf("/mesa-de-regalos/busqueda") > -1) {
          ...
          (async () => {
            ...
            if ( window.location.search == "?lid=181bfaba-3a80-42c8-9473-33f2874ad72d") {
                 /* Layout de Prueba*/
                 var urlTest1='/expoplomeria';
                ...
                */
                ...
                var ulrProd1='/1373?map=productClusterIds';
                if($('#productsSlider01 .prateleira').length){
                   $('.home .products-slider__wrapper .products-slider__container #productsSlider01 .prateleira > h2').append('<a class="text-center d-none d-md-inline-block fw-normal mb-3" href="'+ ulrProd1 +'"><p class="ms-3 text-decoration-none">Ver todo <svg class="svg-icon"><use href="#svg-icon-chevron-right"></use></svg></p></a>');
                }
